...
const bannerData = [
  ...
  {
    id: "banner-3",
    topText: "Riding Accessories",
    titleText: "For Long Rides",
  ...
  },
  {
    id: "banner-4",
    topText: "Super Deal",
    titleText: "On Sports Bike Modifications",
...

  {
    id: "banner-5",
    topText: "Sport Naked",
    titleText: "Select Perfect Street Fighter",
    bottomText: "best naked street fighter segment",
    buttonLink: "/naked",
    buttonText: "Shop Now",
    imgSource: staticImages.hero_img5,
  },
];
...
const featuredData = [
  ...
  },
  {
    ...
    topText: "Beyond Presents",
    largeText: "Breezy Summer Sale",
...
const accessories = [...products.slice(4, 11), products[1]];

const mods = products.slice(11, 15);
...
const footerData = [
  ...
  },
  {
    ...
    title: "Location",
    lists: [
      { text: "support@pritamraha.in" },
      { text: "Gitanjali By Lane, Rabindra Pally" },
      { text: "Durgapur City, INDIA" },
      { text: "Phone: +91 9749215498" },
    ],
  },
];
...
const socialLinksData = [
  {
    id: "social_link_1",
    site_name: "facebook",
    site_icon: staticImages.fbIcon,
    site_url: "www.facbook.com",
  },
  {
    id: "social_link_2",
    site_name: "instagram",
    site_icon: staticImages.instaIcon,
    site_url: "www.instagram.com",
  },
  {
    id: "social_link_3",
    site_name: "twitter",
    site_icon: staticImages.X,
    site_url: "www.twitter.com",
  },
  {
    id: "social_link_4",
    site_name: "linkedin",
    site_icon: staticImages.linkedIn,
